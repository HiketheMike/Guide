...
if selected_guide == "Anaconda Navigator":
    ...
    - <span style='color:green;'>**Installation:**</span> Go to https://code.visualstudio.com/download, and download the version suitable with your device operating system.

    - <span style='color:green;'>**Setting up Jupyter and Python extension:**</span> Following the VSC interface above...
    ...
    - <span style='color:green;'>**Opening a Jupyter Notebook:**</span> After that, go to the activity bar and look for **Explorer**, in here there are 3 options for you to open a Jupyter notebook file...  
    ...
    - <span style='color:green;'>**Running a Jupyter Notebook:**</span> A Jupyter notebook allows you to *write codes* and *plain texts*, to run code cell...
